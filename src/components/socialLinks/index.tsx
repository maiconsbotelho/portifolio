  ...
  return (
    <nav className="flex flex-wrap items-center gap-4">
      <MotionLink
        ...
        className="cursor-pointer rounded-full border-2 bg-background p-2 text-foreground transition-all duration-300 ease-linear lg:border-primaryColor lg:bg-transparent lg:p-3 lg:text-primaryColor lg:hover:border-black lg:hover:bg-black lg:hover:text-white lg:hover:shadow-githubColor lg:dark:hover:shadow-githubColorDark lg:dark:hover:shadow-primaryColor"
      >
