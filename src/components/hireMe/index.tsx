...
const HireMe = () => {
  return (
    <div className="customLG:right-8 customLG:left-auto customLG:top-2 customLG:bottom-auto fixed customLG:absolute bottom-0 left-4 flex items-center justify-center overflow-hidden">
