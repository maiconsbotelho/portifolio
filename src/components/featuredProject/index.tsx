...
const FeaturedProject: React.FC<ProjectProps> = ({
  ...
  return (
    <article className="dark:shadow-quadro relative flex w-full items-center justify-between rounded-3xl rounded-br-2xl border border-solid dark:bg-black dark:border-white border-black bg-white p-6 shadow-quadroDark">
      <Link
        href={link}
        target="_blank"
