...
const TransitionEffects: React.FC<TransitionEffectsProps> = ({ children }) => {
  return (
    <>
      ...
      <motion.div
        className="fixed bottom-0 right-full top-0 z-20 h-screen w-screen bg-ligthTheme"
        initial={{ x: '100%', width: '100%' }} // Corrigido aqui
        animate={{ x: '0%', width: '0%' }}
      ...
      <motion.div
        className="fixed bottom-0 right-full top-0 z-10 h-screen w-screen bg-darkTheme"
        initial={{ x: '100%', width: '100%' }} // Corrigido aqui
        animate={{ x: '0%', width: '0%' }}
